        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Habits_Amounts_AmountId",
                        column: x => x.AmountId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Habits_RecurringTypes_RecurringTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_RecurringTypes_RecurringTypeId",
                        column: x => x.RecurringTypeId,
                        principalTable: "RecurringTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Quit a bad habit" },
                    { 2, null, "Art" },
                    { 3, null, "Task" },
                    { 4, null, "Meditation" },
                    { 5, null, "Study" },
                    { 6, null, "Sports" },
                    { 7, null, "Entertainment" },
                    { 8, null, "Social" },
                    { 9, null, "Finance" },
                    { 10, null, "Health" },
                    { 11, null, "Work" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Habits_RecurringTypeId",
                table: "Habits",
